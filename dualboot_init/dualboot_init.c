...
#define PARTITION_SYSTEM "/dev/block/platform/sdhci-tegra.3/by-name/APP"
#define PARTITION_SYSTEM1 "/dev/block/platform/sdhci-tegra.3/by-name/AP1"
#define PARTITION_BOOT "/dev/block/platform/sdhci-tegra.3/by-name/LNX"
#define PARTITION_BOOT1 "/dev/block/platform/sdhci-tegra.3/by-name/LN1"
#define PARTITION_MODEM "/dev/block/platform/sdhci-tegra.3/by-name/MDM"
#define PARTITION_USERDATA "/dev/block/platform/sdhci-tegra.3/by-name/UDA"
